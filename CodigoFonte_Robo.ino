...
#define F_R_MOTOR0  8     // Drives motor backwards
#define F_R_MOTOR1  9     // Drives motor forwards
#define B_R_MOTOR0  6     // Drives motor backwards
#define B_R_MOTOR1  11    // Drives motor forwards

#define B_L_MOTOR1  5     // Drives motor forwards
#define B_L_MOTOR0  3     // Drives motor backwards 
#define F_L_MOTOR1  A5    // Drives motor forwards
...
// #define LCD_RW      GND;  // RW set to ground, write mode selected
...
/*---------------------------------------------|Pins For Controlling The Robot Through The HT12 RF Controller|---------------------------------------------*/
#define HT_PIN_D8   14
#define HT_PIN_D9   15
...
void rideForwards(int period) // Robot rides fowards 
{ 
  int i = 0;
